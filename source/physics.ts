import {vec2, vec2_add2, vec2_addmuls2, vec2_clamp2, vec2_clone, vec2_copy, vec2_dir1, vec2_dot, vec2_muls1, vec2_muls2, vec2_neg, vec2_refl, vec2_sub1, vec2_zero} from "@cl/vec2.ts";
